...
public class GroundItem {
	 ...
	 *            the amount of the item
	 * @param controller
	 *            the player id, the controller
	 * @param hideTicks
	 *            the amount of ticks until hidden
	 * @param name
	...
	/**
	 * The ground item must be displayed on a height level. The ground item can
	 * only appear on the height level its created on.
	 * 
