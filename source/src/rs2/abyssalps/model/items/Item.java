...
public class Item {
	...
	private static String[] fullbody = { "top", "platebody", "Ahrims robetop",
			"Karils leathertop", "brassard", "Robe top", "robetop",
			"platebody (t)", "platebody (g)", "chestplate", "torso", "hauberk",
			"Dragon chainbody", "robe (t)", "robe (g)", "tunic", "tabard",
			"Granite body", "Rock-shell plate" };
	...
	private static String[] fullhat = { "med helm", "coif", "Dharok's helm",
			...
			"Warrior helm", "Void", "Granite helm", "Rock-shell helm",
			"Pirate bandana" };
	/* Fullmask covers your entire head. */
	private static String[] fullmask = { "full helm", "Cat mask",
			"Goblin mask", "Imp mask", "Frog mask", "Penguin mask",
			"Verac's helm", "Guthan's helm", "Karil's coif", "Torag's helm",
			"Void", "sallet", "Slayer helmet", "helm (g)", "helm (t)" };

	public static boolean isFullBody(int itemId) {
		String weapon = ItemAssistant.getItemName(itemId);
		if (weapon == null)
			return false;
