package rs2.abyssalps.content.minigame.barrows;
...
public class Barrows {
	...
	{ 1674, 20722, 3537, 9703, 20669, 3577, 3282 }, /** Guthans */
	...
	public void checkCoffins() {
		...
		} else if (c.getPoints()[1] == 5) {
			Server.npcHandler.spawnNpc(c, 1673, c.getX(), c.getY() - 1, 3, 0,
	 ...
	 */
	public void reward() {
		c.getItems().addItem(randomRunes(), Misc.random(100) + 100);
		c.getItems().addItem(randomRunes(), Misc.random(100) + 100);
		...
		} else if (c.getPoints()[1] >= 10 && c.getPoints()[1] < 20) {
			if (Misc.random(5) == 0)
				c.getItems().addItem(randomBarrows(), 1);
		} else if (c.getPoints()[1] >= 20 && c.getPoints()[1] < 35) {
			if (Misc.random(3) == 0)
				c.getItems().addItem(randomBarrows(), 1);
		} else if (c.getPoints()[1] >= 35 && c.getPoints()[1] < 50) {
			if (Misc.random(2) == 0)
				c.getItems().addItem(randomBarrows(), 1);
		} else {
			c.getItems().addItem(randomBarrows(), 1);
		...
		if (Misc.random(50) == 0) {
			if (c.getItems().freeSlots() > 0) {
				...
				Server.itemHandler.createGroundItem(c, randomBarrows(),
						c.getX(), c.getY(), c.heightLevel, 1, c.playerId);
			}
		}
	}
	...
	public void useChest() {
		...
		if (c.getPoints()[1] > 5 && checkBarrows()) {
