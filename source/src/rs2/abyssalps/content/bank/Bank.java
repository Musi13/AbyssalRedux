package rs2.abyssalps.content.bank;
...
public class Bank {
	...
	private BankTab[] bankTabs = { new BankTab(0), new BankTab(1),
			new BankTab(2), new BankTab(3), new BankTab(4), new BankTab(5),
			new BankTab(6), new BankTab(7), new BankTab(8) };
