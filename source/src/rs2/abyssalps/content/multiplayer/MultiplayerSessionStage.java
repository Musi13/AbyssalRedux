...
public class MultiplayerSessionStage {
	...
	/**
	 * Represents the stage where some interaction may take place in the session
	 * before finalization
	 */
	public static final int FURTHER_INTERACTION = 4;

	/**
	 * Represents the final stage of the trade which lasts for only a short
	 * period of time.
	 */
	...
	/**
	 * The attachment to the trade stage, this will more than likely be a player
	 * object that will be attatched when they have confirmed a certain stage.
	 */
	...
	/**
	 * Allows use to create a new trade stage, with a default stage id, and an
	 * object as an attachment to the trade stage.
	 * 
	 * @param stage
	 * @param attachment
	 */
