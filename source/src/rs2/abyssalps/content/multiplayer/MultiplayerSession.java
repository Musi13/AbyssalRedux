...
public abstract class MultiplayerSession implements
		MultiplayerSessionItemDistribution, MultiplayerSessionLog {
	...
	public void refreshItemContainer(Client player, Client other,
			int containerId) {
	...
	public void finish(MultiplayerSessionFinalizeType type) {
		if (stage.getStage() == MultiplayerSessionStage.FINALIZE) {
			throw new IllegalStateException(
					"Attempted to finish session after already being finished once before.");
		}
