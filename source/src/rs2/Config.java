...
public class Config {
	...
	public static final boolean FIGHT_PITS_ACTIVE = true;
	...
	public static final int[] ITEM_SELLABLE = { 3842, 3844, 3840, 8844, 8845,
			...
			12954, 13124, 10548, 11864, 13116, MaxCape.MAX_CAPE_ID,
			MaxCape.MAX_HOOD_ID, MaxCape.FIRE_MAX_CAPE_ID,
			MaxCape.FIRE_MAX_HOOD_ID, MaxCape.AVAS_MAX_CAPE_ID,
			MaxCape.AVAS_MAX_HOOD_ID, MaxCape.SARADOMIN_MAX_CAPE_ID,
			MaxCape.SARADOMIN_MAX_HOOD_ID, MaxCape.GUTHIX_MAX_CAPE_ID,
			MaxCape.GUTHIX_MAX_HOOD_ID, MaxCape.ZAMORAK_MAX_CAPE_ID,
			MaxCape.ZAMORAK_MAX_HOOD_ID }; // what
	// items
	// can't
	// be
	// sold
	...
	public static final int[] ITEM_TRADEABLE = { 3842, 3844, 3840, 8844, 8845,
			...
			9800, 9806, 9782, 9797, 9794, 9776, 9773, 9779, 9788, 9812, 9767,
			9747, 9753, 9750, 9768, 9756, 9759, 9762, 9801, 9807, 9783, 9798,
			9804, 9780, 9795, 9792, 9774, 9771, 9777, 9786, 9810, 9765, 12954,
			13124, 10548, 11864, 13116, MaxCape.MAX_CAPE_ID,
			MaxCape.MAX_HOOD_ID, MaxCape.FIRE_MAX_CAPE_ID,
			MaxCape.FIRE_MAX_HOOD_ID, MaxCape.AVAS_MAX_CAPE_ID,
			MaxCape.AVAS_MAX_HOOD_ID, MaxCape.SARADOMIN_MAX_CAPE_ID,
			MaxCape.SARADOMIN_MAX_HOOD_ID, MaxCape.GUTHIX_MAX_CAPE_ID,
	...
	// or
	// staked
	public static final int[] UNDROPPABLE_ITEMS = { MaxCape.MAX_CAPE_ID,
			MaxCape.MAX_HOOD_ID, MaxCape.FIRE_MAX_CAPE_ID,
			MaxCape.FIRE_MAX_HOOD_ID, MaxCape.AVAS_MAX_CAPE_ID,
			MaxCape.AVAS_MAX_HOOD_ID, MaxCape.SARADOMIN_MAX_CAPE_ID,
			MaxCape.SARADOMIN_MAX_HOOD_ID, MaxCape.GUTHIX_MAX_CAPE_ID,
