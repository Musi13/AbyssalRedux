...
public class CycleEventContainer {
	...
	/**
	 * The total sum of game ticks that have passed during the lifetime of the
	 * event
	 */
	private int ticks;
	...
	/**
	 * Randomization occurs during the process of the main game loop. Events
	 * that are randomized are swapped randomly in execution order until there
	 * are none left.
	 * 
	 * @return
	 */
	...
	/**
	 * The number of game ticks that have passed since the creation of the
	 * event.
	 * 
	 * @return game ticks
	 */
